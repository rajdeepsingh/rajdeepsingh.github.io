(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[473],{7077:function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.__rest=/*! *****************************************************************************
...
`,k=i.default.label`
  ...
  font-weight: 700;
  margin-bottom: ${a.getSpacing("s03")};
`;t.AssistMessage=p,t.Border=d,t.CheckRadioErrorArea=C,t.CheckRadioGroupLabel=k,t.CheckRadioGroupWrapper=w,t.CheckRadioHintArea=y,t.CheckRadioInput=h,t.CheckRadioInputGroupWrapper=m,t.CheckRadioLabel=v,t.CheckRadioWrapper=b,t.ErrorMessage=g,t.Label=c,t.LabelWrapper=u,t.SupportingText=f,t.Text=s,t.Wrapper=l},2197:function(e,t,r){"use strict";var n=r(7077),o=r(7294),a=r(7885),i=r(1829),l=r(342),u=r(948),c=r(7547),s=o&&"object"==typeof o&&"default"in o?o:{default:o};t.K=function(e){var{autoComplete:t=!1,disabled:r=!1,label:d,id:f,name:p,placeholder:g,required:b=!0,showCharCount:h=!1,width:m,maxChar:v,minChar:y,hasError:C=!1,errorText:w,touched:k,assistText:$,optionalText:x="Optional",variant:S,onChange:A,onKeyUp:B,onBlur:I,onFocus:z,value:O}=e,j=n.__rest(e,["autoComplete","disabled","label","id","name","placeholder","required","showCharCount","width","maxChar","minChar","hasError","errorText","touched","assistText","optionalText","variant","onChange","onKeyUp","onBlur","onFocus","value"]);let[E,L]=o.useState(0),[D,P]=o.useState(!1);o.useEffect(()=>{O&&"string"==typeof O&&L(O.length)},[]),o.useEffect(()=>{P(void 0===k?C:C&&k)},[C,k]);let M=i.getTestOrTrackId(j["data-testid"]);return s.default.createElement(l.Wrapper,{"data-testid":M("text-area"),width:m},s.default.createElement(l.LabelWrapper,{disabled:r,hasLabel:!!(null==d?void 0:d.length)},d&&s.default.createElement(l.Label,{htmlFor:f||`input-${p}`,disabled:r},d),!b&&!h&&s.default.createElement(l.Text,null,x),h&&s.default.createElement(l.Text,{"data-testid":M("character-count")},u.getCharacterCount(E,v))),s.default.createElement(l.Border,{hasError:D,disabled:r},s.default.createElement(c.TextAreaInput,{id:f||`input-${p}`,name:p,placeholder:g,variant:S,autoComplete:t?"on":"off",disabled:r,maxLength:v,minLength:y,value:String(O),onChange:function(e){L(e.target.value.length),A(e)},onKeyUp:B,onBlur:I,onFocus:z,"data-testid":M(),"data-trackid":j["data-trackid"],"aria-label":j["aria-label"]||d})),s.default.createElement(l.SupportingText,null,!!w&&D&&!r&&s.default.createElement(l.ErrorMessage,null,s.default.createElement(a.default,{width:20,height:20}),w),!D&&("string"==typeof $?s.default.createElement(l.AssistMessage,null,$):$)))}},7547:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(9521),o=r(1829),a=r(948);let i=(n&&"object"==typeof n&&"default"in n?n:{default:n}).default.textarea`
...
`;t.TextAreaInput=i},6027:function(e,t,r){"use strict";var n=r(7077),o=r(7294),a=r(2561),i=r(1829),l=r(342),u=r(948),c=r(9515),s=o&&"object"==typeof o&&"default"in o?o:{default:o};let d=o.forwardRef(function(e,t){var{autoComplete:r=!1,id:d,name:f,label:p,value:g,type:b="text",placeholder:h,hasError:m=!1,errorText:v,assistText:y,optionalText:C="Optional",disabled:w=!1,variant:k="medium",required:$=!0,maxChar:x,minChar:S,showCharCount:A=!1,width:B,prefix:I,suffix:z,onSuffixClick:O,onChange:j,touched:E,onBlur:L,onFocus:D,onPaste:P,onKeyUp:M}=e,_=n.__rest(e,["autoComplete","id","name","label","value","type","placeholder","hasError","errorText","assistText","optionalText","disabled","variant","required","maxChar","minChar","showCharCount","width","prefix","suffix","onSuffixClick","onChange","touched","onBlur","onFocus","onPaste","onKeyUp"]);let[T,F]=o.useState(0),[R,W]=o.useState(!1);o.useEffect(()=>{g&&"string"==typeof g&&F(g.length)},[]),o.useEffect(()=>{W(void 0===E?m:m&&E)},[m,E]);let H=i.getTestOrTrackId(_["data-testid"]);return s.default.createElement(l.Wrapper,{"data-testid":H("text-field"),width:B},s.default.createElement(l.LabelWrapper,{disabled:w,hasLabel:!!(null==p?void 0:p.length)},p&&s.default.createElement(l.Label,{htmlFor:d||`input-${f}`,disabled:w},p),!$&&!A&&s.default.createElement(l.Text,null,C),A&&s.default.createElement(l.Text,{"data-testid":H("char-count")},u.getCharacterCount(T,x))),s.default.createElement(l.Border,{hasError:R,disabled:w,hasPrefix:!!I,hasSuffix:!!z},!!I&&s.default.createElement(c.Prefix,{"data-testid":H("prefix")},I),s.default.createElement(c.TextFieldInput,{hasError:R,ref:t,id:d||`input-${f}`,type:b,variant:k,disabled:w,placeholder:h,autoComplete:r?"on":"off",maxLength:x,minLength:S,value:String(g),onChange:function(e){F(e.target.value.length),j(e)},onKeyUp:M,onBlur:L,onFocus:D,onPaste:P,"data-trackid":_["data-trackid"],"data-testid":H(),"aria-label":_["aria-label"]||p,name:f}),!!z&&s.default.createElement(c.Sufix,{"data-testid":H("suffix"),hasHandler:!!O,onClick:O&&O},z)),s.default.createElement(l.SupportingText,null,!!v&&R&&!w&&s.default.createElement(l.ErrorMessage,null,s.default.createElement(a.default,{width:20,height:20}),v),!R&&("string"==typeof y?s.default.createElement(l.AssistMessage,null,y):y)))});t.n=d},9515:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(9521),o=r(1829),a=r(948),i=n&&"object"==typeof n&&"default"in n?n:{default:n};let l=i.default.input`
  color: ${o.getColorAlias("contentDefault")};
  font-family: ${e=>e.theme.font.familyPrimary};
  background: ${e=>e.disabled?o.getColorAlias("disabled01"):"transparent"};
  ${o.getFontSize("size16")};
